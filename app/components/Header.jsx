...
const Header = () => {
  return (
    <div className="w-11/12 max-w-3wl text-center mx-auto h-screen flex flex-col items-center justify-center gap-4">
      <motion.div
        initial={{ scale: 0 }}
        whileInView={{ scale: 1 }}
      ...
      <motion.h1
        ...
        whileInView={{ y: 0, opacity: 1 }}
        transition={{ duration: 0.8, delay: 0.5 }}
        className="text-3xl sm:text-6xl lg:text-[50px] font-sans"
      >
        {" "}
        based in India.
      </motion.h1>
