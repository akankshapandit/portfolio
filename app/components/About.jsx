  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Image src={assets.my_photo} alt="user" className=" rounded-3xl" />
        </motion.div>
        <motion.div
          initial={{ opacity: 0 }}
          whileInView={{ opacity: 1 }}
        ...
        >
          <p className="mb-10 max-w-2xl font-Ovo">
            ...
            on various projects that enhanced my understanding of
            component-based architecture, state management, and responsive
            design principles. I’m passionate about continuous learning and
          ...
          >
            {infoList.map(({ icon, iconDark, title, description }, index) => (
              <motion.li
                ...
                className="border-[0.5px] border-gray-400 rounded-xl p-6 cursor-pointer hover:bg-gray-100 hover:-translate-y-1 duration-500 shadow hover:shadow-black"
                key={index}
              >
