...
const Navbar = () => {
  ...
  return (
    ...
    flex items-center justify-between z-50 ${isScroll?"bg-white/[0.65] backdrop-blur-lg shadow-sm":""}`}>
        <a href="#top" className="">
            <Image src={assets.name_logo} alt='' className='w-35 alt="" cursor-pointer h-15 bg-transparent mr-14'/>
        </a>

        <ul className={`hidden md:flex items-center gap-6 lg:gap-8 rounded-full px-12 py-3 ${isScroll?"":" bg-white/[.65] shadow-sm "} `}>
        ...
        <div className='flex items-center gap-4'>
            ...
            <a className='font-Ovo hidden lg:flex items-center gap-3 px-10 py-2.5 border border-gray-500 rounded-full ml-4' href="#contact">Contact 
